...
class SetLowShooterSpeedsThenFeedWhenReady
    : public frc2::CommandHelper<frc2::SequentialCommandGroup,
                                 SetLowShooterSpeedsThenFeedWhenReady> {
 public:
  SetLowShooterSpeedsThenFeedWhenReady(ShooterSubsystem* ShooterSUB, StorageSubsystem* StorageSUB); // , std::function<double()> BottomTargetSpeedFunction, std::function<double()> TopTargetSpeedFunction
