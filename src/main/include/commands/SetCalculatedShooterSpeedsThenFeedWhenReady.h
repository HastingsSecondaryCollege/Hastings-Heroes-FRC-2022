...
class SetCalculatedShooterSpeedsThenFeedWhenReady
    : public frc2::CommandHelper<frc2::SequentialCommandGroup,
                                 SetCalculatedShooterSpeedsThenFeedWhenReady> {
 public:
  SetCalculatedShooterSpeedsThenFeedWhenReady(ShooterSubsystem* ShooterSUB, StorageSubsystem* StorageSUB, DriveSubsystem* DriveSUB,LimelightSubsystem* LimeSUB);  
