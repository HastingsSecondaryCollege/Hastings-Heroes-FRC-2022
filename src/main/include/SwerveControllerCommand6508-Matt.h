...
class SwerveControllerCommand
 ...
 public:
  ...
  SwerveControllerCommand(
      ...
      //std::function<frc::Rotation2d(int&, double&)> desiredRotation,
      //std::function<frc::Rotation2d()> desiredRotation,
...
Subsystem* requirements = {}
 ...
 private:
  ...
  frc::Trajectory *m_trajectories;//[AutoConstants::kMaxTrajectories];
  int m_trajectoryIndex;
  int m_wayFileIndex;
  int m_trajectoryCount;
  int m_iterations;
  std::function<frc::Pose2d()> m_pose;
  frc::SwerveDriveKinematics<NumModules> m_kinematics;
  frc::HolonomicDriveController m_controller;
  std::function<double(int,int,double)> m_desiredRotation;
  std::function<void(std::array<frc::SwerveModuleState, NumModules>)>
      m_outputStates;
