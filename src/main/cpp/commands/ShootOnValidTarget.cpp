...
ShootOnValidTarget::ShootOnValidTarget(ShooterSubsystem* ShooterSUB, StorageSubsystem* StorageSUB, DriveSubsystem* DriveSUB,LimelightSubsystem* LimeSUB) 
...
{
AddCommands(
  StopShootingSequenceOnNoTarget(m_limelightSUB),
