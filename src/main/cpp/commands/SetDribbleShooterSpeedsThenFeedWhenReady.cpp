...
SetDribbleShooterSpeedsThenFeedWhenReady::SetDribbleShooterSpeedsThenFeedWhenReady(ShooterSubsystem* ShooterSUB, StorageSubsystem* StorageSUB) // , std::function<double()> BottomTargetSpeedFunction, std::function<double()> TopTargetSpeedFunction
...
//  m_topTargetSpeedFunction{TopTargetSpeedFunction}

 {
  ...
  AddCommands(
    SetBottomMotorTargetSpeed(m_shooterSUB, [this] {return kBottomOpponentBallSpeed;}), // [this] {return kBottomFenderLowSpeed;}) // m_bottomTargetSpeedFunction
    SetTopMotorTargetSpeed(m_shooterSUB, [this] {return kTopOpponentBallSpeed;}), // [this] {return kTopFenderLowSpeed;}) // m_topTargetSpeedFunction
